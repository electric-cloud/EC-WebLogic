...
assert queueName
def jndiName = 'com.test.updateQueueSDName'
...
project projName, {
    procedure procName, {
        ...
        step 'Create JMS Queue', {
            ...
            actualParameter 'ecp_weblogic_update_action', 'selective_update'
        }
        ...
        step 'Update JMS Queue', {
            ...
            actualParameter 'ecp_weblogic_jms_queue_name', queueName
            actualParameter 'ecp_weblogic_jndi_name', jndiName
            actualParameter 'ecp_weblogic_subdeployment_name', "new_$queueName"
