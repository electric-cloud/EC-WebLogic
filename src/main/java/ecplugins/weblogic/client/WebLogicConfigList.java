...
public class WebLogicConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, WebLogicConfigInfo> m_configInfo =
        new TreeMap<String, WebLogicConfigInfo>();
    ...
    public void addConfig(
            ...
            String configUrl)
    {
        m_configInfo.put(configName, new WebLogicConfigInfo(configUrl));
    }
    ...
    private class WebLogicConfigInfo
    {
        ...
        public WebLogicConfigInfo(String url)
        {
            m_url = url;
        }
    }
