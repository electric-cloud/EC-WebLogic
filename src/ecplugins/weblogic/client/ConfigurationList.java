...
/**
 * EC-WebLogic Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private WebLogicConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "WebLogic Configurations", "All Configurations");
        m_configList = new WebLogicConfigList();
    }
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-WebLogic/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the WebLogic configuration '"
                            + configName + "'?") {
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "weblogicMonitor.cgi");
